const patchNotes = {
  "7.37a": {
    ...
    generalChangesExtension: [
      ...
      "Способности, направленные на существо и перемещающие владельца, теперь блокируются в момент применения, а не после перемещения. Изменилось поведение следующих способностей:",
